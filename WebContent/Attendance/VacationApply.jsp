				...
				<div id="page-content">							
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title"><strong>휴가신청</strong></h3>
						</div>									
						<form class="form-horizontal">
							<div class="panel-body">
							<div class="form-group">
								<label class="col-sm-3 control-label" for="demo-hor-inputemail">신청일</label>
									<div class="col-sm-2">
										<input type="text" id="demo-hor-inputemail" class="form-control"> 
									</div>
									<label class="col-sm-1 control-label" for="demo-hor-inputemail">휴가 기간</label>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label" for="demo-hor-inputemail">이름</label>
									<div class="col-sm-2">
										<input type="text" id="demo-hor-inputemail" class="form-control"> 
									</div>  
									<label class="col-sm-1 control-label" for="demo-hor-inputemail">휴가 일수</label>
										<div class="col-sm-2">									
								...
								<div class="form-group">
									<label class="col-sm-3 control-label" for="demo-hor-inputpass">부서</label>	
										...
										<label class="col-sm-1 control-label" for="demo-hor-inputpass">휴가 종류</label>	
										<div class="col-sm-2">									
											<select class="form-control">
												<option>선택</option>
												<option>오전반차</option>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label" for="demo-hor-inputpass">직급</label>	
										<div class="col-sm-2">
											<input type="text" id="demo-hor-inputemail" class="form-control"> 
										</div>	
								...
								<div class="form-group">
										<label class="col-sm-3 control-label" for="demo-hor-inputemail">휴가 사유</label>	
										<div class="col-sm-7">	 								
		...
		<div class="boxed" style="margin-top: -120px">	
			<div id="content-container">
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title"><strong>나의 휴가 신청 내역</strong></h3>
						</div>									
							...
							<table id="demo-foo-pagination" class="table table-striped table-bordered" data-page-size="5">
								...
								<tbody>
									...
									<tr>
										...
										<td>2020/09/09~2020/09/09</td>
										<td>1일</td>
										<td><span class="label label-table label-dark">대기중</span></td>
										<td>개인 사정</td>
									</tr>
									<tr>
										<td>2020/09/02</td>										

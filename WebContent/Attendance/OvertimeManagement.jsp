				...
				<div id="page-content">							
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title"><strong>직원 초과 근무 수당 신청 내역 조회</strong></h3>
						</div>									
		...
		<div class="boxed" style="margin-top: -120px">	
			<div id="content-container">
				<div id="page-content">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title"><strong>직원 초과 근무 수당 신청 내역</strong></h3>
						</div>									
							...
							<table id="demo-foo-pagination" class="table table-striped table-bordered" data-page-size="5">
								<thead>
									<tr>
										...
										<th>직급</th>									
										<th>처리상태</th>									
										<th data-hide="all">초과 근무 일자</th>
										<th data-hide="all">초과 근무 시간</th>
										<th data-hide="all">초과 시간</th>
